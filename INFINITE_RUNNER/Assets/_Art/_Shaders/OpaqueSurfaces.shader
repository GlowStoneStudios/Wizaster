...
////// Lighting:
                ...
                float3 finalColor = ((saturate((node_7782*clamp(max(0,dot(normalDirection,node_246)),0.3,3)))+((pow(max(0,dot(node_246,viewReflectDirection)),3.0)*_SpecularPower)*0.66*node_7782*0.0)+(float3(0.2300498,0.2598907,0.2720588)*0.66*node_7782))*UNITY_LIGHTMODEL_AMBIENT.rgb);
