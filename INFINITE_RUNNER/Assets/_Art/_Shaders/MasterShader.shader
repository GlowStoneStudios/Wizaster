...
////// Lighting:
                ...
                float3 finalColor = (lerp((node_3494_if_leA*node_5294)+(node_3494_if_leB*node_3294),node_5294,node_3494_if_leA*node_3494_if_leB)*UNITY_LIGHTMODEL_AMBIENT.rgb);
