...
Shader "GlowStone Studios/Lava2" {
    Properties {
        ...
        _FlowChangeSpeed ("Flow Change Speed", Range(0, 1)) = 0
...
////// Lighting:
                ...
                fixed4 finalRGBA = fixed4(finalColor,saturate((sceneZ-partZ)/_BorderBlend));
